...
const MEMBERS = [
  {
    ...
    bio: 'saya adalah seorang Fullstack Developer & Game Developer yang sedang mengarungi lautan teknik Informatika semester 5. Sehari-hari disibukkan dengan meracik logika backend, mendesain UI/UX yang estetik, hingga membangun dunia game sendiri.',
  ...
  },
  {
    ...
    bio: 'Saya seorang developer web sekaligus artis 3D building menggunakan software blender, terkadang saya mempelajari engine game seperti unity dan unreal engine. Saya juga memiliki keahlian di bidang ui/ux website dan mockup landing page.',
    label: 'Informatika – Semester 5',
  ...
  {
    fullname: 'Member Lima',
    firstname: 'Member5',
    photo: 'https://placehold.co/400x500/2c2c54/ffffff?text=Member+5',
    bio: 'Pengembang mobile app berbasis Android dan Flutter. Bermimpi membangun startup di bidang edukasi teknologi.',
    label: 'Informatika – Semester 5',
